...
hive \
	...
	-f "$ROOT_DIR/lib/ddl/com/cloudera/cyclehire/main/process/table/partitioned_create.ddl"
...
hive \
	...
	$CMD_LINE_ARGUMENTS \
	-f "$ROOT_DIR/lib/ddl/com/cloudera/cyclehire/main/process/table/processed_create.ddl"
